...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateFuelingRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/fuelings/{fuelingID}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Dados atualizados do abastecimento",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateFuelingRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.CreateFuelingRequest": {
            "type": "object",
            "properties": {
                "date": {
                    "type": "string",
                    "example": "2026-09-08T15:04:05Z"
                },
                "fuelType": {
                    "type": "string",
                ...
                "notes": {
                    "type": "string",
                    "example": "Tanque cheio após viagem"
                },
                "pricePerLiter": {
                    "type": "number",
                    "example": 5.89
